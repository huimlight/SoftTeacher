    ...
    train=dict(
        ...
        sup=dict(
            ...
            dataset=dict(
                ...
                pipeline=[
                    dict(type='Mosaic', img_scale=(800, 1333), pad_val=32),
                    dict(
                        type='RandomAffine',
        ...
        unsup=dict(
            ...
            dataset=dict(
                ...
                classes=classes,
                ann_file=
                'data/coco/annotations/semi_supervised/instances_train2017.1@1-unlabeled.json',
                img_prefix='data/coco/train2017/',
                pipeline=[
                    dict(type='LoadImageFromFile'),
...
checkpoint_config = dict(interval=4000, by_epoch=False, max_keep_ckpts=50)
log_config = dict(
    interval=50,
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='pre_release',
                name='soft_teacher_faster_rcnn_r50_caffe_fpn_coco_180k',
                config=dict(
                    fold=1,
                    percent=1,
                    work_dirs='work_dirs/soft_teacher_mosaic_affine_mixup/1/1',
                    total_step=180000)),
            by_epoch=False)
    ])
custom_hooks = [
...
fold = 1
percent = 1
work_dir = 'work_dirs/soft_teacher_faster_rcnn_r50_caffe_fpn_coco_180k/1/1'
cfg_name = 'soft_teacher_mosaic_affine_mixup'
